...
class AccountManager(BaseUserManager):
    ...
    def create_user(self, email, username,first_name,last_name, phone, password, **extra_fields):
        ...
        extra_fields.setdefault('is_nonvip', True)
    ...
    def create_superuser(self, email, username,first_name,last_name, phone, password, **extra_fields):
        ...
        if extra_fields.get('is_vip') is not True:
            raise ValueError('Superuser must have is_vip=True.')
        if extra_fields.get('is_nonvip') is not True:
            raise ValueError('Superuser must have is_nonvip=True.')
...
class Account(AbstractBaseUser, PermissionsMixin):
    ...
    is_nonvip = models.BooleanField(default=True)
